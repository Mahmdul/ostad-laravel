...
class Car {
    ...
    public function set_make( $make ) {//ekhaen set_make method ta "Car" class er vitor thaka 3 ta property er value ke change korse
        $this->make = $make;
    }

    public function set_model( $model ) {//ekhaen set_model method ta "Car" class er vitor thaka 3 ta property er value ke change korse
        $this->model = $model;
    }

    public function set_year( $year ) {//ekhaen set_year method ta "Car" class er vitor thaka 3 ta property er value ke change korse
        $this->year = $year;
    }
